...
(function(root, factory) {
  ...
  describe('TPSApi', function() {
    describe('aPITPSGeMonthlyDataByYearGet', function() {
      it('should call aPITPSGeMonthlyDataByYearGet successfully', function(done) {
        //uncomment below and update the code to test aPITPSGeMonthlyDataByYearGet
        //instance.aPITPSGeMonthlyDataByYearGet(function(error) {
