...
(function(root, factory) {
  ...
  describe('GPSApi', function() {
    describe('aPIGPSGeMonthlyDataByYearGet', function() {
      it('should call aPIGPSGeMonthlyDataByYearGet successfully', function(done) {
        //uncomment below and update the code to test aPIGPSGeMonthlyDataByYearGet
        //instance.aPIGPSGeMonthlyDataByYearGet(function(error) {
