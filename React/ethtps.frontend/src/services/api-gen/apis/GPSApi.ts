...
export class GPSApiRequestFactory extends BaseAPIRequestFactory {
     ...
     * @param year 
     */
    public async aPIGPSGeMonthlyDataByYearGet(provider?: string, network?: string, includeSidechains?: boolean, year?: number, _options?: Configuration): Promise<RequestContext> {
     ...
     * @param interval 
     */
    public async aPIGPSGetGet(provider?: string, network?: string, includeSidechains?: boolean, interval?: string, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;
     ...
     * @param includeSidechains 
     */
    public async aPIGPSInstantGet(provider?: string, network?: string, includeSidechains?: boolean, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;
     ...
     * @param includeSidechains 
     */
    public async aPIGPSMaxGet(provider?: string, network?: string, includeSidechains?: boolean, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;
...
export class GPSApiResponseProcessor {
     ...
     */
    public async aPIGPSGeMonthlyDataByYearGet(response: ResponseContext): Promise<{ [key: string]: Array<DataResponseModel>; }> {
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
    public async aPIGPSGetGet(response: ResponseContext): Promise<{ [key: string]: Array<DataResponseModel>; }> {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
            const body: { [key: string]: Array<DataResponseModel>; } = ObjectSerializer.deserialize(
                ObjectSerializer.parse(await response.body.text(), contentType),
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
    public async aPIGPSInstantGet(response: ResponseContext): Promise<{ [key: string]: Array<DataPoint>; }> {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
    public async aPIGPSMaxGet(response: ResponseContext): Promise<{ [key: string]: DataPoint; }> {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
