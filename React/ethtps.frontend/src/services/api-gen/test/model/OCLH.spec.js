...
(function(root, factory) {
  ...
  describe('OCLH', function() {
    it('should create an instance of OCLH', function() {
      // uncomment below and update the code to test OCLH
      //var instance = new EthtpsApi.OCLH();
      //expect(instance).to.be.a(EthtpsApi.OCLH);
    });
