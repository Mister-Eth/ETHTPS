...
export class PromiseGPSApi {
  ...
  public aPIGPSGeMonthlyDataByYearGet(
    ...
    const result = this.api.aPIGPSGeMonthlyDataByYearGet(
      provider,
      network,
      includeSidechains,
      year,
  ...
  public aPIGPSGetGet(
    ...
    const result = this.api.aPIGPSGetGet(
      provider,
      network,
      includeSidechains,
      interval,
  ...
  public aPIGPSInstantGet(
    ...
    const result = this.api.aPIGPSInstantGet(
      provider,
      network,
      includeSidechains,
      _options,
  ...
  public aPIGPSMaxGet(
    ...
    const result = this.api.aPIGPSMaxGet(
      provider,
      network,
      includeSidechains,
      _options,
...
export class PromiseGasAdjustedTPSApi {
  ...
  public constructor(
    ...
    this.api = new ObservableGasAdjustedTPSApi(
      configuration,
      requestFactory,
      responseProcessor,
    )
  ...
  public aPIGasAdjustedTPSGeMonthlyDataByYearGet(
    ...
    const result = this.api.aPIGasAdjustedTPSGeMonthlyDataByYearGet(
      provider,
      network,
      includeSidechains,
      year,
  ...
  public aPIGasAdjustedTPSGetGet(
    ...
    const result = this.api.aPIGasAdjustedTPSGetGet(
      provider,
      network,
      includeSidechains,
      interval,
  ...
  public aPIGasAdjustedTPSInstantGet(
    ...
    const result = this.api.aPIGasAdjustedTPSInstantGet(
      provider,
      network,
      includeSidechains,
      _options,
  ...
  public aPIGasAdjustedTPSMaxGet(
    ...
    const result = this.api.aPIGasAdjustedTPSMaxGet(
      provider,
      network,
      includeSidechains,
      _options,
...
export class PromiseGeneralApi {
  ...
  public constructor(
    ...
    this.api = new ObservableGeneralApi(
      configuration,
      requestFactory,
      responseProcessor,
    )
  ...
  public aPIV2GetIntervalsWithDataGet(
    ...
    const result = this.api.aPIV2GetIntervalsWithDataGet(
      provider,
      network,
      includeSidechains,
      _options,
  ...
  public aPIV2GetUniqueDataYearsGet(
    ...
    const result = this.api.aPIV2GetUniqueDataYearsGet(
      provider,
      network,
      includeSidechains,
      _options,
  ...
  public aPIV2InstantDataGet(
    ...
    const result = this.api.aPIV2InstantDataGet(
      provider,
      network,
      includeSidechains,
      smoothing,
  ...
  public aPIV2MaxGet(
    ...
    const result = this.api.aPIV2MaxGet(
      provider,
      network,
      includeSidechains,
      _options,
...
export class PromiseIngestionApi {
  ...
  public constructor(
    ...
    this.api = new ObservableIngestionApi(
      configuration,
      requestFactory,
      responseProcessor,
    )
...
export class PromisePageModelApi {
  ...
  public constructor(
    ...
    this.api = new ObservablePageModelApi(
      configuration,
      requestFactory,
      responseProcessor,
    )
  ...
  public aPIPagesHomeGet(
    ...
    const result = this.api.aPIPagesHomeGet(
      subchainsOf,
      interval,
      dataType,
      provider,
  ...
  public aPIPagesProviderGet(
    ...
    const result = this.api.aPIPagesProviderGet(
      interval,
      dataType,
      provider,
      network,
...
export class PromiseStatusApi {
  ...
  public apiStatusGetBlockInfoProviderStatusGet(
    ...
    const result = this.api.apiStatusGetBlockInfoProviderStatusGet(
      provider,
      network,
      includeSidechains,
      _options,
...
export class PromiseTPSApi {
  ...
  public aPITPSGeMonthlyDataByYearGet(
    ...
    const result = this.api.aPITPSGeMonthlyDataByYearGet(
      provider,
      network,
      includeSidechains,
      year,
  ...
  public aPITPSGetGet(
    ...
    const result = this.api.aPITPSGetGet(
      provider,
      network,
      includeSidechains,
      interval,
  ...
  public aPITPSInstantGet(
    ...
    const result = this.api.aPITPSInstantGet(
      provider,
      network,
      includeSidechains,
      _options,
  ...
  public aPITPSMaxGet(
    ...
    const result = this.api.aPITPSMaxGet(
      provider,
      network,
      includeSidechains,
      _options,
...
export class PromiseTimeWarpApi {
  ...
  public constructor(
    ...
    this.api = new ObservableTimeWarpApi(
      configuration,
      requestFactory,
      responseProcessor,
    )
  ...
  public aPITimeWarpGetGPSAtGet(
    ...
    const result = this.api.aPITimeWarpGetGPSAtGet(
      provider,
      network,
      includeSidechains,
      timestamp,
  ...
  public aPITimeWarpGetGasAdjustedTPSAtGet(
    ...
    const result = this.api.aPITimeWarpGetGasAdjustedTPSAtGet(
      provider,
      network,
      includeSidechains,
      timestamp,
  ...
  public aPITimeWarpGetSyncProgressGet(
    ...
    const result = this.api.aPITimeWarpGetSyncProgressGet(
      provider,
      network,
      includeSidechains,
      _options,
  ...
  public aPITimeWarpGetTPSAtGet(
    ...
    const result = this.api.aPITimeWarpGetTPSAtGet(
      provider,
      network,
      includeSidechains,
      timestamp,
