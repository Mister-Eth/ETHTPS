...
export class PageModelApiRequestFactory extends BaseAPIRequestFactory {
  ...
  public async aPIPagesHomeGet(
    ...
    if (interval !== undefined) {
      requestContext.setQueryParam(
        "Interval",
        ObjectSerializer.serialize(interval, "TimeInterval", ""),
      )
    }
    ...
    if (dataType !== undefined) {
      requestContext.setQueryParam(
        "DataType",
        ObjectSerializer.serialize(dataType, "DataType", ""),
      )
    }
   ...
   * @param includeSidechains
   */
  public async aPIPagesProviderGet(
    interval?: TimeInterval,
    dataType?: DataType,
    provider?: string,
    network?: string,
