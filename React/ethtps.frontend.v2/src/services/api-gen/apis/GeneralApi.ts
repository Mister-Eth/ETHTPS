...
export class GeneralApiRequestFactory extends BaseAPIRequestFactory {
  ...
  /**
   */
  public async aPIV2ColorDictionaryGet(
    _options?: Configuration,
  ): Promise<RequestContext> {
    let _config = _options || this.configuration
   ...
   */
  public async aPIV2GetIntervalsWithDataGet(
    provider?: string,
    network?: string,
   ...
   * @param includeSidechains
   */
  public async aPIV2GetUniqueDataYearsGet(
    provider?: string,
    network?: string,
    includeSidechains?: boolean,
    _options?: Configuration,
   ...
   * @param smoothing
   */
  public async aPIV2InstantDataGet(
    provider?: string,
    network?: string,
    includeSidechains?: boolean,
    smoothing?: string,
    ...
    if (smoothing !== undefined) {
      requestContext.setQueryParam(
        "smoothing",
        ObjectSerializer.serialize(smoothing, "string", ""),
      )
    }
  ...
  /**
   */
  public async aPIV2IntervalsGet(
    _options?: Configuration,
  ): Promise<RequestContext> {
    let _config = _options || this.configuration
  ...
  /**
   */
  public async aPIV2ProviderTypesColorDictionaryGet(
    _options?: Configuration,
  ): Promise<RequestContext> {
    let _config = _options || this.configuration
   ...
   * @param subchainsOf
   */
  public async aPIV2ProvidersGet(
    subchainsOf?: string,
    _options?: Configuration,
  ): Promise<RequestContext> {
    let _config = _options || this.configuration
    ...
    if (subchainsOf !== undefined) {
      requestContext.setQueryParam(
        "subchainsOf",
        ObjectSerializer.serialize(subchainsOf, "string", ""),
      )
    }
