...
export class GasAdjustedTPSApiRequestFactory extends BaseAPIRequestFactory {
   ...
   * @param year
   */
  public async aPIGasAdjustedTPSGeMonthlyDataByYearGet(
    provider?: string,
    network?: string,
   ...
   * @param interval
   */
  public async aPIGasAdjustedTPSGetGet(
    provider?: string,
    network?: string,
    includeSidechains?: boolean,
    interval?: string,
   ...
   * @param includeSidechains
   */
  public async aPIGasAdjustedTPSInstantGet(
    provider?: string,
    network?: string,
    includeSidechains?: boolean,
    _options?: Configuration,
   ...
   * @param includeSidechains
   */
  public async aPIGasAdjustedTPSMaxGet(
    provider?: string,
    network?: string,
    includeSidechains?: boolean,
    _options?: Configuration,
