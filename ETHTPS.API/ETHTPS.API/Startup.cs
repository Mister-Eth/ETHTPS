    ...
    public class Startup
    {
        ...
        private void AddHistoricalBlockInfoDataUpdaters(IServiceCollection services)
        {
            if (ConfigurationQueues.Contains(HISTORICALUPDATERQUEUE))
            {
                     ...
                     services.RegisterHistoricalHangfireDateBackgroundService<HangfireDateHistoricalBlockInfoProviderDataLogger<DiversiFiBlockInfoProvider>, DiversiFiBlockInfoProvider>(CronConstants.Never, HISTORICALUPDATERQUEUE);
        ...
        private void AddTPSDataUpdaters(IServiceCollection services)
        {
            if (ConfigurationQueues.Contains(TPSUPDATERQUEUE))
            {
                ...
                services.RegisterHangfireBackgroundService<HangfireBlockInfoProviderDataLogger<SorareBlockInfoProvider>, SorareBlockInfoProvider>(CronConstants.EveryMidnight, TPSUPDATERQUEUE);
                services.RegisterHangfireBackgroundService<HangfireBlockInfoProviderDataLogger<DiversiFiBlockInfoProvider>, DiversiFiBlockInfoProvider>(CronConstants.EveryMidnight, TPSUPDATERQUEUE);
            }
        }
