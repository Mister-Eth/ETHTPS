...
export function ProviderModal(config) {
    ...
    return (_jsx(Fragment, { children: _jsx(Modal, { keepMounted: false, open: config.open, "aria-labelledby": "parent-modal-title", "aria-describedby": "parent-modal-description", onClose: () => {
                setNoData(false);
                config.onClose();
