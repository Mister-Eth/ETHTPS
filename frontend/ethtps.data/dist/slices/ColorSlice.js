...
exports.colorReducer =
  exports.setProviderTypeColorDictionary =
  exports.setProviderColorDictionary =
    void 0;
const toolkit_1 = require("@reduxjs/toolkit");
const initialState = JSON.parse(
  (_b = localStorage.getItem("IColorDictionaries")) !== null && _b !== void 0
    ? _b
    : "{}"
);
...
(_a = colorSlice.actions),
  (exports.setProviderColorDictionary = _a.setProviderColorDictionary),
  (exports.setProviderTypeColorDictionary = _a.setProviderTypeColorDictionary);
