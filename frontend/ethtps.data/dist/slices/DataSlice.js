...
exports.dataReducer =
  exports.setMaxGTPSData =
  exports.setMaxGPSData =
  exports.setMaxTPSData =
    void 0;
const toolkit_1 = require("@reduxjs/toolkit");
const ethtps_api_client_1 = require("ethtps.api.client");
const initialState = {
  maxTPSData: JSON.parse(
    (_b = localStorage.getItem("maxTPSData")) !== null && _b !== void 0
      ? _b
      : "{}"
  ),
  maxGPSData: JSON.parse(
    (_c = localStorage.getItem("maxGPSData")) !== null && _c !== void 0
      ? _c
      : "{}"
  ),
  maxGTPSData: JSON.parse(
    (_d = localStorage.getItem("maxGTPSData")) !== null && _d !== void 0
      ? _d
      : "{}"
  ),
...
const dataSlice = (0, toolkit_1.createSlice)({
  ...
  reducers: {
    setMaxTPSData(state, action) {
      localStorage.setItem(action.payload, "maxTPSData");
      return modifyMaxDataState(state, action.payload, (s) => s.maxTPSData);
    },
    setMaxGPSData(state, action) {
      localStorage.setItem(action.payload, "maxGPSData");
      return modifyMaxDataState(state, action.payload, (s) => s.maxGPSData);
    },
    setMaxGTPSData(state, action) {
      localStorage.setItem(action.payload, "maxGTPSData");
      return modifyMaxDataState(state, action.payload, (s) => s.maxGTPSData);
    },
  },
});
(_a = dataSlice.actions),
  (exports.setMaxTPSData = _a.setMaxTPSData),
  (exports.setMaxGPSData = _a.setMaxGPSData),
  (exports.setMaxGTPSData = _a.setMaxGTPSData);
