...
exports.liveDataReducer =
  exports.setLastMinuteData =
  exports.setIncludeSidechains =
  exports.setLiveData =
  exports.setLiveDataType =
  exports.setLiveDataSmoothing =
  exports.setCurrentVisitors =
    void 0;
...
const initialState = {
  ...
  includeSidechains:
    (_b = JSON.parse(localStorage.getItem("includeSidechains"))) !== null &&
    _b !== void 0
      ? _b
      : false,
  ...
  reducers: {
    setCurrentVisitors(state, action) {
      ...
      state.currentVisitors =
        (_a = action.payload) !== null && _a !== void 0 ? _a : 1;
    },
    ...
    setIncludeSidechains(state, action) {
      var _a;
      localStorage.setItem(action.payload, "includeSidechains");
      state.includeSidechains =
        (_a = action.payload) !== null && _a !== void 0 ? _a : false;
    },
    setLastMinuteData(state, action) {
      switch (state.liveDataType) {
        case ethtps_api_client_1.DataType.Tps:
          localStorage.setItem(action.payload, "oneMinuteTPSData");
          state.oneMinuteTPSData = action.payload;
          break;
        case ethtps_api_client_1.DataType.Gps:
          localStorage.setItem(action.payload, "oneMinuteGPSData");
...
(_a = liveDataSlice.actions),
  (exports.setCurrentVisitors = _a.setCurrentVisitors),
  (exports.setLiveDataSmoothing = _a.setLiveDataSmoothing),
  (exports.setLiveDataType = _a.setLiveDataType),
  (exports.setLiveData = _a.setLiveData),
  (exports.setIncludeSidechains = _a.setIncludeSidechains),
  (exports.setLastMinuteData = _a.setLastMinuteData);
