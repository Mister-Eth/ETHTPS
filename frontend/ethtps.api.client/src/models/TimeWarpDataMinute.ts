...
export function TimeWarpDataMinuteFromJSONTyped(json: any, ignoreDiscriminator: boolean): TimeWarpDataMinute {
...
export function TimeWarpDataMinuteToJSON(value?: TimeWarpDataMinute | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
