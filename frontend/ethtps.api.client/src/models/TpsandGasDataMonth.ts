...
export function TpsandGasDataMonthFromJSONTyped(json: any, ignoreDiscriminator: boolean): TpsandGasDataMonth {
...
export function TpsandGasDataMonthToJSON(value?: TpsandGasDataMonth | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
