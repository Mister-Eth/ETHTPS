...
export class TimeWarpApiRequestFactory extends BaseAPIRequestFactory {
  /**
   */
  public async aPITimeWarpGetEarliestDateGet(
   ...
   * @param count
   */
  public async aPITimeWarpGetGPSAtGet(
    provider?: string,
    network?: string,
    ...
    if (count !== undefined) {
      requestContext.setQueryParam(
        "count",
        ObjectSerializer.serialize(count, "number", "int32"),
      )
    }
   ...
   * @param count
   */
  public async aPITimeWarpGetGasAdjustedTPSAtGet(
    provider?: string,
    network?: string,
    includeSidechains?: boolean,
    timestamp?: number,
   ...
   * @param includeSidechains
   */
  public async aPITimeWarpGetSyncProgressGet(
    provider?: string,
    network?: string,
    includeSidechains?: boolean,
    _options?: Configuration,
   ...
   * @param count
   */
  public async aPITimeWarpGetTPSAtGet(
    provider?: string,
    network?: string,
    includeSidechains?: boolean,
    timestamp?: number,
